(function($) {
    ...
    $('#progress-bar').appear(function() {
        ...
        $('#bar6').barfiller({ barColor: '#6c62ff', duration: 3000 });
        $('#bar7').barfiller({ barColor: '#6c62ff', duration: 4000 });
        $('#bar8').barfiller({ barColor: '#6c62ff', duration: 1000 });
        $('#bar9').barfiller({ barColor: '#6c62ff', duration: 3000 });
        $('#bar10').barfiller({ barColor: '#6c62ff', duration: 7000 });
    });
